...
import { getByCategory, CATEGORY_META, getAllCategories } from "@/lib/quotes";
...
export default function CategoryPage({ params }: PageProps) {
  ...
  if (!validCategories.includes(params.slug as QuoteCategory)) {
    notFound();
  }

  const category = params.slug as QuoteCategory;
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8 pt-4">
            ...
            <p className="text-white/60">
              {allQuotes.length} câu trích dẫn
            </p>
          </div>
